...
load(file = "2_models/1_simulation/simulated_dataset/v3/B_simulation_v3.Rda")
load(file = "2_models/1_simulation/simulated_dataset/v3/marr_simulation_v3.Rda")
load(file = "2_models/1_simulation/simulated_dataset/v3/CH_simulation_v3.Rda")


# Bundle data  ------------------------------------------------------------

n.colony = nrow(B) #   5 # number of colonies in this survey
n.years = ncol(B)  # 20 # number of years in this survey
...
cat(file = "2_models/2_models_for_real/v15/models/v15_4.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v15/models/v15_4.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)


save(out1, file = "/lustre/rumianowskio/out1_on_simul_v1.Rda")
