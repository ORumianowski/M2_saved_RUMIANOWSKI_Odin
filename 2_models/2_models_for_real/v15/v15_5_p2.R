...
cat(file = "2_models/2_models_for_real/v15/models/v15_5_assec.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v15/models/v15_5_assec.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)


save(out1, file = "/lustre/rumianowskio/out1_v15_5_assec.txt.Rda")
